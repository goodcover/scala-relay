...
import com.goodcover.relay.codegen.OperationInputWriter.newInputName
import com.goodcover.relay.codegen.ScalaWriter.Parameter
...
class OperationInputWriter(
  ...
  def writeNewInputMethod(): Unit = {
    ...
    scalaWriter.writeProxyMethod(newInputName, parameters, fullyQualifiedName, fullyQualifiedName, compact = false, "  ")
  }
}
