...
object TestOptionalListVariableQuery
    extends _root_.com.goodcover.relay.QueryTaggedNode[TestOptionalListVariableQueryInput, TestOptionalListVariableQuery] {
  type Ctor[T] = T
