...
object TestPrimitiveResponseMutation
    extends _root_.com.goodcover.relay.MutationTaggedNode[TestPrimitiveResponseMutationInput, TestPrimitiveResponseMutation] {
  type Ctor[T] = T
