...
/**
 * This is one level higher than what's returned by relay, the query is what's
 * returned by `Relay`
 */
 ...
 *
 * @tparam F
 *   fragment value type constructor (`js.Array` for plural fragments, otherwise
 *   `Id`).
 * @tparam O
 *   fragment value type.
 * @tparam X
 *   inline indicator (`Inline` for inline fragments, otherwise `Any`).
 */
@js.native
