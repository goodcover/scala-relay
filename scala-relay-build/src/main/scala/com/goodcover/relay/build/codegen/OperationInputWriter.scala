...
class OperationInputWriter(
  ...
  def writeOperationInputType(): Unit = {
    ...
    new InputWriter(writer, input, document, schema = null, typeConverter).write()
  }

  def writeNewInputMethod(): Unit = {
    val fullyQualifiedName = "_root_.relay.generated." + operationInputName
    scalaWriter.writeProxyMethod(Term.Name(newInputName), parameters, fullyQualifiedName, fullyQualifiedName, compact = false, "  ")
  }
}

object OperationInputWriter {
  val newInputName = "newInput"
}
