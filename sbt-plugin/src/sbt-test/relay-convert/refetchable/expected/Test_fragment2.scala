...
object Test_fragment2 extends _root_.relay.gql.FragmentRefetchableTaggedNode[Test_fragment2, ArgsInput, Args] {
  type Ctor[T] = T
  ...
  @js.native
  @JSImport("__generated/Test_fragment2.graphql", JSImport.Default)
